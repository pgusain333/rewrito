...
export const SAMPLES: Record<ToolType, string> = {
  ...
  plagiarism: `Artificial intelligence has revolutionized the modern workplace by increasing efficiency, improving decision-making, and enabling organizations to achieve transformational outcomes. Companies that adopt AI technologies can gain a competitive advantage because these systems streamline processes and unlock innovation across departments.`,
